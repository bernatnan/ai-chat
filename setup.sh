...
chown -R 1000:1000 logs uploads generated_files images skill
echo "  -> Done!"
...
echo "     docker exec -it ollama ollama pull phi4-mini:q4"
echo "     docker exec -it ollama ollama pull phi4-mini:q4_k_m"
echo "     docker exec -it ollama ollama pull qwen2.5"
echo "     docker exec -it ollama ollama pull qwen2.5:7b-instruct-q4_k_m"
echo "     docker exec -it ollama ollama pull deepseek-r1"
echo "     docker exec -it ollama ollama pull llama3.2"
echo "     docker exec -it ollama ollama pull llama3.2:3b-instruct-q4_0"
echo ""
echo "     In case need to remove a model:"
echo "         docekr exec -it ollama ollama rm MODEL_NAME"
echo "           e.g: docekr exec -it ollama ollama rm phi4-mini:q4"
echo ""
